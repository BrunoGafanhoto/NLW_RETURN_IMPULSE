...

        {
            Object.entries(feedbackTypes).map(([key, value], index) => {
                return (
                    ...
                    className="gap-2 p-2 flex flex-col items-center justify-center rounded-lg bg-zinc-700 w-24 h-28 flex-1 border-2 border-transparent hover:border-brand-500 focus:border-brand-500 focus:outline-none">
