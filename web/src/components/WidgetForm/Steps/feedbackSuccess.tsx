...
export const FeedbackSuccess = ({ onFeedbackRestartRequested }: FeedbackSuccessProps) => {
     return (
          <>
               <header>
                    <CloseButton />
               ...
               <div className="flex flex-col items-center py-10 w-[304px]" >
                    ...
                    <button
                         // type="button"
                         className="py-2 px-6 mt-6 bg-zinc-800 text-sm rounded-md border-transparent leading-6 hover:bg-zinc-700 transition-colors
